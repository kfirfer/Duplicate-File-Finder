...
public class Main extends javax.swing.JFrame implements ItemListener {
    ...
    private void initChanges() {
    	...
    	for (int i=0;i<4;i++) {
    		...
    		switch(i) {
    		case 0: tc.setPreferredWidth(150); break;
    		case 1: tc.setPreferredWidth(60); tc.setMaxWidth(80); break;
    		case 2: tc.setPreferredWidth(620); break;
    		case 3: tc.setPreferredWidth(50); tc.setMaxWidth(50); break;
    		}
    ...
    private void initComponents() {
        ...
        jFileChooser.setCurrentDirectory(new java.io.File("C:\\"));
            ...
            checkBoxPanelLayout.setHorizontalGroup(
                ...
                .addGroup(checkBoxPanelLayout.createSequentialGroup()
                    ...
                    .addGroup(checkBoxPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                        .addComponent(boxByName, javax.swing.GroupLayout.DEFAULT_SIZE, 144, Short.MAX_VALUE)
                        .addComponent(boxBySize, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                        .addComponent(boxByHash, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
                    .addContainerGap())
            );
            checkBoxPanelLayout.setVerticalGroup(
                ...
                .addGroup(checkBoxPanelLayout.createSequentialGroup()
                    .addContainerGap()
                    .addComponent(boxByName)
                    .addGap(18, 18, 18)
                    .addComponent(boxBySize)
                    .addGap(18, 18, 18)
                    .addComponent(boxByHash)
                                ...
                                .addGroup(layout.createSequentialGroup()
                                    ...
                                    .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                        ...
                                        .addGroup(layout.createSequentialGroup()
                                            ...
                                            .addComponent(checkAllButton, javax.swing.GroupLayout.PREFERRED_SIZE, 113, javax.swing.GroupLayout.PREFERRED_SIZE)
                                            .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                                            .addComponent(uncheckAllButton, javax.swing.GroupLayout.PREFERRED_SIZE, 113, javax.swing.GroupLayout.PREFERRED_SIZE)
                                            .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                                            .addComponent(checkOnlyOne)))
                                    .addGap(27, 143, Short.MAX_VALUE)
                                    .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                        .addComponent(removeButton, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.PREFERRED_SIZE, 79, javax.swing.GroupLayout.PREFERRED_SIZE)
                                        .addComponent(searchButton, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.PREFERRED_SIZE, 133, javax.swing.GroupLayout.PREFERRED_SIZE)))
                                .addGroup(layout.createSequentialGroup()
	...
	public void errorHandles(int errorType) {
		...
		switch(errorType) {
		case 1:
			optionPane = new JOptionPane("No selected folder", JOptionPane.ERROR_MESSAGE, JOptionPane.CLOSED_OPTION , null, null, "");
			dialog = optionPane.createDialog(null, "Error");
			break;
		case 2:
			optionPane = new JOptionPane("No selected Box", JOptionPane.ERROR_MESSAGE, JOptionPane.CLOSED_OPTION , null, null, "");
			dialog = optionPane.createDialog(null, "Error");

			break;
		case 3:
			optionPane = new JOptionPane("File Not Found", JOptionPane.ERROR_MESSAGE, JOptionPane.CLOSED_OPTION , null, null, "");
			dialog = optionPane.createDialog(null, "Error");

			break;
		case 4:
			optionPane = new JOptionPane("File not associated with the operating system", JOptionPane.ERROR_MESSAGE, JOptionPane.CLOSED_OPTION , null, null, "");
			dialog = optionPane.createDialog(null, "Error");

			break;
		case 5:
			optionPane = new JOptionPane("This Button is under Construction", JOptionPane.ERROR_MESSAGE, JOptionPane.CLOSED_OPTION , null, null, "");
			dialog = optionPane.createDialog(null, "Error");
			break;
		case 6:
			optionPane = new JOptionPane("You run the latest version", JOptionPane.INFORMATION_MESSAGE, JOptionPane.CLOSED_OPTION , null, null, "");
			dialog = optionPane.createDialog(null, "Update");
			break;
		case 7:
			optionPane = new JOptionPane("Unable login to server", JOptionPane.ERROR_MESSAGE, JOptionPane.CLOSED_OPTION , null, null, "");
